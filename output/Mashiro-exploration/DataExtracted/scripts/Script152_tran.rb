...
#~ 使い方は、イベントコマンドのスクリプトで下のように書けばズームします。
...
#~ 画面の中心から拡大させる場合はfalseです。
#~ refresh_rate はよく分らないので、とりあえずデモと同じように記述しています。
#~ （このスクリプトを書かなくてもズームはします）

#~ 元に戻したい時は、下のようにzoomを100にすればOKです。

#~     map_effects.set_zoom(100, 60, true)
#~ $imported ||= {}
